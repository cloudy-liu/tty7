...
Markdown previews have their own **Markdown reading theme** selector in Appearance.
The default is Paperglow, with light and dark variants that follow the active app
mode. See [Markdown reading themes](/customization/markdown-themes) for installing
YAML packages and editing them with live reload.
